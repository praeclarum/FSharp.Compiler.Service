// This is a generated file; the original input is '/Users/fak/Projects/FSharp.Compiler.Service/src/fsharp/fsi/FSIstrings.txt'
...
type internal SR private() =
    ...
    /// (Originally from /Users/fak/Projects/FSharp.Compiler.Service/src/fsharp/fsi/FSIstrings.txt:2)
    static member stoppedDueToError() = (GetStringFunc("stoppedDueToError",",,,") )
    /// Usage: %s <options> [script.fsx [<arguments>]]
    /// (Originally from /Users/fak/Projects/FSharp.Compiler.Service/src/fsharp/fsi/FSIstrings.txt:3)
    static member fsiUsage(a0 : System.String) = (GetStringFunc("fsiUsage",",,,%s,,,") a0)
    /// - INPUT FILES -
    /// (Originally from /Users/fak/Projects/FSharp.Compiler.Service/src/fsharp/fsi/FSIstrings.txt:4)
    static member fsiInputFiles() = (GetStringFunc("fsiInputFiles",",,,") )
    /// - CODE GENERATION -
    /// (Originally from /Users/fak/Projects/FSharp.Compiler.Service/src/fsharp/fsi/FSIstrings.txt:5)
    static member fsiCodeGeneration() = (GetStringFunc("fsiCodeGeneration",",,,") )
    /// - ERRORS AND WARNINGS -
    /// (Originally from /Users/fak/Projects/FSharp.Compiler.Service/src/fsharp/fsi/FSIstrings.txt:6)
    static member fsiErrorsAndWarnings() = (GetStringFunc("fsiErrorsAndWarnings",",,,") )
    /// - LANGUAGE -
    /// (Originally from /Users/fak/Projects/FSharp.Compiler.Service/src/fsharp/fsi/FSIstrings.txt:7)
    static member fsiLanguage() = (GetStringFunc("fsiLanguage",",,,") )
    /// - MISCELLANEOUS -
    /// (Originally from /Users/fak/Projects/FSharp.Compiler.Service/src/fsharp/fsi/FSIstrings.txt:8)
    static member fsiMiscellaneous() = (GetStringFunc("fsiMiscellaneous",",,,") )
    /// - ADVANCED -
    /// (Originally from /Users/fak/Projects/FSharp.Compiler.Service/src/fsharp/fsi/FSIstrings.txt:9)
    static member fsiAdvanced() = (GetStringFunc("fsiAdvanced",",,,") )
    /// Exception raised when starting remoting server.\n%s
    /// (Originally from /Users/fak/Projects/FSharp.Compiler.Service/src/fsharp/fsi/FSIstrings.txt:10)
    ...
    /// (Originally from /Users/fak/Projects/FSharp.Compiler.Service/src/fsharp/fsi/FSIstrings.txt:11)
    static member fsiUse() = (GetStringFunc("fsiUse",",,,") )
    /// #load the given file on startup
    /// (Originally from /Users/fak/Projects/FSharp.Compiler.Service/src/fsharp/fsi/FSIstrings.txt:12)
    ...
    /// (Originally from /Users/fak/Projects/FSharp.Compiler.Service/src/fsharp/fsi/FSIstrings.txt:13)
    static member fsiRemaining() = (GetStringFunc("fsiRemaining",",,,") )
    /// Display this usage message (Short form: -?)
    /// (Originally from /Users/fak/Projects/FSharp.Compiler.Service/src/fsharp/fsi/FSIstrings.txt:14)
    ...
    /// (Originally from /Users/fak/Projects/FSharp.Compiler.Service/src/fsharp/fsi/FSIstrings.txt:15)
    static member fsiExec() = (GetStringFunc("fsiExec",",,,") )
    /// Execute interactions on a Windows Forms event loop (on by default)
    /// (Originally from /Users/fak/Projects/FSharp.Compiler.Service/src/fsharp/fsi/FSIstrings.txt:16)
    static member fsiGui() = (GetStringFunc("fsiGui",",,,") )
    /// Suppress fsi writing to stdout
    /// (Originally from /Users/fak/Projects/FSharp.Compiler.Service/src/fsharp/fsi/FSIstrings.txt:17)
    static member fsiQuiet() = (GetStringFunc("fsiQuiet",",,,") )
    /// Support TAB completion in console (on by default)
    /// (Originally from /Users/fak/Projects/FSharp.Compiler.Service/src/fsharp/fsi/FSIstrings.txt:18)
    static member fsiReadline() = (GetStringFunc("fsiReadline",",,,") )
    /// Emit debug information in quotations
    /// (Originally from /Users/fak/Projects/FSharp.Compiler.Service/src/fsharp/fsi/FSIstrings.txt:19)
    static member fsiEmitDebugInfoInQuotations() = (GetStringFunc("fsiEmitDebugInfoInQuotations",",,,") )
    /// For help type #help;;
    /// (Originally from /Users/fak/Projects/FSharp.Compiler.Service/src/fsharp/fsi/FSIstrings.txt:20)
    ...
    /// (Originally from /Users/fak/Projects/FSharp.Compiler.Service/src/fsharp/fsi/FSIstrings.txt:21)
    static member fsiConsoleProblem() = (GetStringFunc("fsiConsoleProblem",",,,") )
    /// '%s' is not a valid assembly name
    /// (Originally from /Users/fak/Projects/FSharp.Compiler.Service/src/fsharp/fsi/FSIstrings.txt:22)
    static member fsiInvalidAssembly(a0 : System.String) = (2301, GetStringFunc("fsiInvalidAssembly",",,,%s,,,") a0)
    /// Directory '%s' doesn't exist
    /// (Originally from /Users/fak/Projects/FSharp.Compiler.Service/src/fsharp/fsi/FSIstrings.txt:23)
    ...
    /// (Originally from /Users/fak/Projects/FSharp.Compiler.Service/src/fsharp/fsi/FSIstrings.txt:24)
    ...
    /// (Originally from /Users/fak/Projects/FSharp.Compiler.Service/src/fsharp/fsi/FSIstrings.txt:25)
    static member fsiLineTooLong() = (GetStringFunc("fsiLineTooLong",",,,") )
    /// Real: %s, CPU: %s, GC %s
    /// (Originally from /Users/fak/Projects/FSharp.Compiler.Service/src/fsharp/fsi/FSIstrings.txt:26)
    ...
    /// gen
    /// (Originally from /Users/fak/Projects/FSharp.Compiler.Service/src/fsharp/fsi/FSIstrings.txt:27)
    ...
    /// (Originally from /Users/fak/Projects/FSharp.Compiler.Service/src/fsharp/fsi/FSIstrings.txt:28)
    static member fsiExceptionDuringPrettyPrinting(a0 : System.String) = (GetStringFunc("fsiExceptionDuringPrettyPrinting",",,,%s,,,") a0)
    ///   F# Interactive directives:
    /// (Originally from /Users/fak/Projects/FSharp.Compiler.Service/src/fsharp/fsi/FSIstrings.txt:29)
    ...
    /// (Originally from /Users/fak/Projects/FSharp.Compiler.Service/src/fsharp/fsi/FSIstrings.txt:30)
    static member fsiIntroTextHashrInfo() = (GetStringFunc("fsiIntroTextHashrInfo",",,,") )
    /// Add the given search path for referenced DLLs
    /// (Originally from /Users/fak/Projects/FSharp.Compiler.Service/src/fsharp/fsi/FSIstrings.txt:31)
    ...
    /// (Originally from /Users/fak/Projects/FSharp.Compiler.Service/src/fsharp/fsi/FSIstrings.txt:32)
    static member fsiIntroTextHashloadInfo() = (GetStringFunc("fsiIntroTextHashloadInfo",",,,") )
    /// Toggle timing on/off
    /// (Originally from /Users/fak/Projects/FSharp.Compiler.Service/src/fsharp/fsi/FSIstrings.txt:33)
    static member fsiIntroTextHashtimeInfo() = (GetStringFunc("fsiIntroTextHashtimeInfo",",,,") )
    /// Display help
    /// (Originally from /Users/fak/Projects/FSharp.Compiler.Service/src/fsharp/fsi/FSIstrings.txt:34)
    static member fsiIntroTextHashhelpInfo() = (GetStringFunc("fsiIntroTextHashhelpInfo",",,,") )
    /// Exit
    /// (Originally from /Users/fak/Projects/FSharp.Compiler.Service/src/fsharp/fsi/FSIstrings.txt:35)
    static member fsiIntroTextHashquitInfo() = (GetStringFunc("fsiIntroTextHashquitInfo",",,,") )
    ///   F# Interactive command line options:
    /// (Originally from /Users/fak/Projects/FSharp.Compiler.Service/src/fsharp/fsi/FSIstrings.txt:36)
    static member fsiIntroTextHeader2commandLine() = (GetStringFunc("fsiIntroTextHeader2commandLine",",,,") )
    ///       See '%s' for options
    /// (Originally from /Users/fak/Projects/FSharp.Compiler.Service/src/fsharp/fsi/FSIstrings.txt:37)
    static member fsiIntroTextHeader3(a0 : System.String) = (GetStringFunc("fsiIntroTextHeader3",",,,%s,,,") a0)
    /// Loading
    /// (Originally from /Users/fak/Projects/FSharp.Compiler.Service/src/fsharp/fsi/FSIstrings.txt:38)
    static member fsiLoadingFilesPrefixText() = (GetStringFunc("fsiLoadingFilesPrefixText",",,,") )
    /// \n- Interrupt\n
    /// (Originally from /Users/fak/Projects/FSharp.Compiler.Service/src/fsharp/fsi/FSIstrings.txt:39)
    static member fsiInterrupt() = (GetStringFunc("fsiInterrupt",",,,") )
    /// \n- Exit...\n
    /// (Originally from /Users/fak/Projects/FSharp.Compiler.Service/src/fsharp/fsi/FSIstrings.txt:40)
    static member fsiExit() = (GetStringFunc("fsiExit",",,,") )
    /// - Aborting main thread...
    /// (Originally from /Users/fak/Projects/FSharp.Compiler.Service/src/fsharp/fsi/FSIstrings.txt:41)
    ...
    /// (Originally from /Users/fak/Projects/FSharp.Compiler.Service/src/fsharp/fsi/FSIstrings.txt:42)
    static member fsiCouldNotInstallCtrlCHandler(a0 : System.String) = (GetStringFunc("fsiCouldNotInstallCtrlCHandler",",,,%s,,,") a0)
    /// --> Referenced '%s'
    /// (Originally from /Users/fak/Projects/FSharp.Compiler.Service/src/fsharp/fsi/FSIstrings.txt:43)
    ...
    /// (Originally from /Users/fak/Projects/FSharp.Compiler.Service/src/fsharp/fsi/FSIstrings.txt:44)
    ...
    /// (Originally from /Users/fak/Projects/FSharp.Compiler.Service/src/fsharp/fsi/FSIstrings.txt:45)
    ...
    /// (Originally from /Users/fak/Projects/FSharp.Compiler.Service/src/fsharp/fsi/FSIstrings.txt:46)
    static member fsiDidAHashI(a0 : System.String) = (GetStringFunc("fsiDidAHashI",",,,%s,,,") a0)
    /// --> Timing now on
    /// (Originally from /Users/fak/Projects/FSharp.Compiler.Service/src/fsharp/fsi/FSIstrings.txt:47)
    static member fsiTurnedTimingOn() = (GetStringFunc("fsiTurnedTimingOn",",,,") )
    /// --> Timing now off
    /// (Originally from /Users/fak/Projects/FSharp.Compiler.Service/src/fsharp/fsi/FSIstrings.txt:48)
    ...
    /// (Originally from /Users/fak/Projects/FSharp.Compiler.Service/src/fsharp/fsi/FSIstrings.txt:49)
    ...
    /// (Originally from /Users/fak/Projects/FSharp.Compiler.Service/src/fsharp/fsi/FSIstrings.txt:50)
    ...
    /// (Originally from /Users/fak/Projects/FSharp.Compiler.Service/src/fsharp/fsi/FSIstrings.txt:51)
    static member fsiBindingSessionTo(a0 : System.String) = (GetStringFunc("fsiBindingSessionTo",",,,%s,,,") a0)
    /// F# Interactive for F# 4.0 %s
    /// (Originally from /Users/fak/Projects/FSharp.Compiler.Service/src/fsharp/fsi/FSIstrings.txt:52)
    ...
    /// (Originally from /Users/fak/Projects/FSharp.Compiler.Service/src/fsharp/fsi/FSIstrings.txt:53)
